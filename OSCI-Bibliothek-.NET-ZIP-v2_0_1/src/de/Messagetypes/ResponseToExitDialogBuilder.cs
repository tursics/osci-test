...
{
    /// <summary><H4>ResponseToExitDialog-Parser</H4>
    /// 
    ...
    /// <p>Version: 2.0.1</p>
    /// </summary>
    public class ResponseToExitDialogBuilder
        : OsciMessageBuilder
    {
        ...
        /// </param>
        public ResponseToExitDialogBuilder(OsciEnvelopeBuilder envelopeBuilder) 
            : base(envelopeBuilder)
        {
            Msg = new ResponseToExitDialog(envelopeBuilder.DialogHandler);
        }
        ...
        public override void StartElement(string uri, string localName, string qName, Attributes attributes)
        {
            ...
            else if (InsideHeader)
            {
                ...
                {
                    EnvelopeBuilder.XmlReader.ContentHandler = new ControlBlockHBuilder(this, attributes, new[] { 1, 0, 1, 1 });
                }
                ...
                else if (localName.Equals("responseToExitDialog") && uri.Equals(OsciXmlns))
                {
                    //nothing to do
                }
