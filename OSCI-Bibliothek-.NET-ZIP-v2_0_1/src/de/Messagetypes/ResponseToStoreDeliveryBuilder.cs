...
{
    /// <summary><H4>ResponseToStoreDelivery-Parser</H4>
    /// 
    ...
    /// <p>Version: 2.0.1</p>
    /// </summary>
    public class ResponseToStoreDeliveryBuilder
        : OsciMessageBuilder
    {
        private static readonly Log _log = LogFactory.GetLog(typeof(ResponseToStoreDeliveryBuilder));
        ...
        /// </param>
        public ResponseToStoreDeliveryBuilder(OsciEnvelopeBuilder envelopeBuilder)
            : base(envelopeBuilder)
        {
            Msg = new ResponseToStoreDelivery(envelopeBuilder.DialogHandler, true);
        }
        ...
        public override void StartElement(string uri, string localName, string qName, Attributes attributes)
        {
            ...
            else if (InsideHeader)
            {
                ...
                else if (localName.Equals("responseToStoreDelivery") && uri.Equals(OsciXmlns))
                {
        ...
        public override void EndElement(string uri, string localName, string qName)
        {
            ...
            if (localName.Equals("Header") && uri.Equals(SoapXmlns))
            {
                ...
                {
                    ((ResponseToStoreDelivery)Msg).ProcessCardBundle = _processCardBuilder.ProcessCardBundleObject;
                }
            }
            else
            {
